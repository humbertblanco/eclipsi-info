...
const STRINGS = {
  ...
  'badge.online': { ca: 'En línia', es: 'En línea', en: 'Online' },
  'badge.offlineSaved': { ca: 'Sense xarxa · desat', es: 'Sin red · guardado', en: 'Offline · saved' },
  'badge.offlineUnsaved': { ca: 'Sense xarxa · no desat', es: 'Sin red · no guardado', en: 'Offline · not saved' },
  ...
  'update.later': { ca: 'Ara no', es: 'Ahora no', en: 'Not now' },
  'update.apply': { ca: 'Actualitza', es: 'Actualiza', en: 'Update' },

  /* --- panell: capçalera i pla ------------------------------------------- */
  'panel.title': { ca: 'Preparar per anar-hi', es: 'Preparar para ir', en: 'Prepare for your trip' },
  'panel.lede': {
  ...
  'figures.point': { ca: 'Punt', es: 'Punto', en: 'Point' },
  'figures.tiles': { ca: 'Tessel·les', es: 'Teselas', en: 'Tiles' },
  'figures.weight': { ca: 'Pes estimat', es: 'Peso estimado', en: 'Estimated size' },
  'figures.range': { ca: 'Radi del relleu', es: 'Radio del relieve', en: 'Terrain radius' },

  /* --- progrés ------------------------------------------------------------
   * Les frases de fase es componen AQUÍ i no a `prepare.ts`: el motor no sap
   * l'idioma de la interfície i no l'ha de saber.                           */
  'progress.label': { ca: 'Progrés de la preparació', es: 'Progreso de la preparación', en: 'Preparation progress' },
  'progress.keepOpen': {
  ...
  'progress.stop': { ca: 'Atura', es: 'Detén', en: 'Stop' },
  'phase.inici': {
  ...
  'phase.relleu': { ca: 'Baixant el relleu…', es: 'Descargando el relieve…', en: 'Downloading terrain…' },
  'phase.mapa': { ca: 'Baixant el mapa…', es: 'Descargando el mapa…', en: 'Downloading map…' },
  'phase.calcul': { ca: 'Calculant l’horitzó…', es: 'Calculando el horizonte…', en: 'Calculating horizon…' },
  'phase.desat': { ca: 'Desant els càlculs…', es: 'Guardando los cálculos…', en: 'Saving calculations…' },
  'phase.fet': { ca: 'Llest per anar-hi', es: 'Listo para ir', en: 'Ready to go' },

  /* --- accions i resultat ------------------------------------------------- */
  'action.prepare': { ca: 'Prepara’m per anar-hi', es: 'Prepárame para ir', en: 'Prepare for my trip' },
  'action.again': { ca: 'Torna a preparar aquest punt', es: 'Vuelve a preparar este punto', en: 'Prepare this point again' },
  'note.offline': {
  ...
  'note.done': { ca: 'Punt preparat. {bytes} desats.', es: 'Punto preparado. {bytes} guardados.', en: 'Point prepared. {bytes} saved.' },
  'note.doneFailed': {
  ...
  /* --- inventari ----------------------------------------------------------- */
  'saved.title': { ca: 'Desat al telèfon', es: 'Guardado en el teléfono', en: 'Saved on this device' },
  'saved.loading': { ca: 'Consultant què hi ha desat…', es: 'Consultando qué hay guardado…', en: 'Checking saved data…' },
  'saved.empty': {
    ca: 'Encara no has preparat cap punt.',
    es: 'Todavía no has preparado ningún punto.',
    en: 'You have not prepared any points yet.',
  },
  'saved.tiles': { ca: 'tessel·les', es: 'teselas', en: 'tiles' },
  'saved.holes': {
  ...
  'saved.remove': { ca: 'Treu', es: 'Quita', en: 'Remove' },
  'saved.removeLabel': { ca: 'Treu {label} de la llista', es: 'Quita {label} de la lista', en: 'Remove {label} from the list' },
  'figures.terrain': { ca: 'Relleu desat', es: 'Relieve guardado', en: 'Terrain saved' },
  'figures.basemap': { ca: 'Mapa desat', es: 'Mapa guardado', en: 'Map saved' },
  'figures.used': { ca: 'Espai ocupat', es: 'Espacio ocupado', en: 'Space used' },
  'figures.free': { ca: 'Espai disponible', es: 'Espacio disponible', en: 'Space available' },
  'saved.clear': {
  ...
  'install.title': { ca: 'Instal·la l’app', es: 'Instala la app', en: 'Install the app' },
  'limits.title': { ca: 'Què pot fallar', es: 'Qué puede fallar', en: 'What can go wrong' },
  'limits.immutable': {

...
export function partialCaveat(
  ...
  const caveats: Record<Locale, string> = {
    ...
    fr: 'Ce n’est pas une petite totalité : c’est un phénomène différent. Tant qu’une fente de photosphère reste visible, le ciel ne s’assombrit pas, la couronne et les planètes n’apparaissent pas, et vous devez garder votre filtre solaire à tout moment.',
  };

...
export const CREDITS: readonly Credit[] = [
  {
    what: { ca: 'Efemèrides', es: 'Efemérides', en: 'Ephemerides', fr: 'Éphémérides' },
  ...
  {
    what: { ca: 'Trajectòria de l’ombra', es: 'Trayectoria de la sombra', en: 'Path of the shadow', fr: 'Trajectoire de l’ombre' },
  ...
  {
    what: { ca: 'Contrast de les prediccions', es: 'Contraste de las predicciones', en: 'Prediction cross-checking', fr: 'Vérification croisée des prévisions' },
    who: 'IGN',
  ...
  {
    what: { ca: 'Model del terreny', es: 'Modelo del terreno', en: 'Terrain model', fr: 'Modèle de terrain' },
  ...
  {
    what: { ca: 'Cartografia i topònims', es: 'Cartografía y topónimos', en: 'Maps and place names', fr: 'Cartographie et noms de lieux' },
  ...
  },
  {
     ...
     */
    what: { ca: 'Miradors i cims', es: 'Miradores y cimas', en: 'Viewpoints and peaks', fr: 'Points de vue et sommets' },
  ...
  {
    what: { ca: 'Meteorologia', es: 'Meteorología', en: 'Weather', fr: 'Météorologie' },
    who: 'Open-Meteo',
...
export const PRIVACY_NOTE: Record<Locale, string> = {
  ...
  fr: 'Les calculs sont effectués sur votre appareil : aucun serveur ne les réalise pour vous. Vos coordonnées sont uniquement transmises pour identifier le lieu et fournir les prévisions, et ne parviennent jamais au service d’analyse d’audience.',
};
...
export const OBSERVATION_SOURCES_HEADING: Record<Locale, string> = {
  ...
  fr: 'Qui publie les sites d’observation officiels',
};
...
export const OBSERVATION_SOURCES_NOTE: Record<Locale, string> = {
  ...
  fr: 'Nous ne désignons pas les zones d’observation officielles : chaque site est proposé par une autorité publique, et toutes celles qui en ont publié un pour cette éclipse sont répertoriées ici.',
};

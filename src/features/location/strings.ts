...
const STRINGS = {
  ...
  'bar.none': { ca: 'Encara no has dit on seràs', es: 'Todavía no has dicho dónde estarás', en: 'You haven’t chosen where you’ll be yet' },
  'bar.change': { ca: 'Canvia el lloc', es: 'Cambia el lugar', en: 'Change location' },
  'bar.open': { ca: 'Tria el lloc', es: 'Elige el lugar', en: 'Choose a location' },

  /* --- d'on surt el punt -------------------------------------------------
   * Quatre paraules com a màxim: van dins d'una insígnia al costat del nom.  */
  'origin.gps': { ca: 'GPS', es: 'GPS', en: 'GPS' },
  'origin.map': { ca: 'Punt del mapa', es: 'Punto del mapa', en: 'Map point' },
  'origin.search': { ca: 'Cercat pel nom', es: 'Buscado por nombre', en: 'Found by name' },
  'origin.recent': { ca: 'De l’historial', es: 'Del historial', en: 'From history' },
  ...
  'origin.link': { ca: 'D’un enllaç', es: 'De un enlace', en: 'From a link' },
  'origin.default': { ca: 'Punt d’exemple', es: 'Punto de ejemplo', en: 'Example point' },
  ...
  /* --- precisió i altitud ------------------------------------------------ */
  'accuracy.gps': { ca: '±{m} m', es: '±{m} m', en: '±{m} m' },
  'elevation.dem': { ca: '{m} m del model del terreny', es: '{m} m del modelo del terreno', en: '{m} m from the terrain model' },
  ...
  /* --- la fulla de tria -------------------------------------------------- */
  'sheet.title': { ca: 'On seràs', es: 'Dónde estarás', en: 'Where you’ll be' },
  'sheet.close': { ca: 'Tanca', es: 'Cerrar', en: 'Close' },
  'sheet.here': { ca: 'On soc ara', es: 'Dónde estoy ahora', en: 'Where I am now' },
  'sheet.locating': { ca: 'Cercant el senyal…', es: 'Buscando la señal…', en: 'Finding your location…' },
  'sheet.mapHint': {
  ...
  'sheet.recents': { ca: 'Últims llocs', es: 'Últimos lugares', en: 'Recent locations' },
  'sheet.recentsEmpty': {
  ...
  'sheet.forget': { ca: 'Treu-lo de la llista', es: 'Quítalo de la lista', en: 'Remove from list' },
  'sheet.compareWith': { ca: 'Compara', es: 'Compara', en: 'Compare' },
  ...
  'sheet.coordsToggle': { ca: 'Tinc coordenades exactes', es: 'Tengo coordenadas exactas', en: 'I have exact coordinates' },
  'sheet.coords': { ca: 'Coordenades', es: 'Coordenadas', en: 'Coordinates' },
  'sheet.coordsHint': {
  ...
  'sheet.use': { ca: 'Fes-lo servir', es: 'Úsalo', en: 'Use this location' },

  /* --- cerca per nom ----------------------------------------------------- */
  'search.label': { ca: 'Cerca un lloc', es: 'Busca un lugar', en: 'Search for a location' },
  ...
  'search.exact': { ca: 'Punt exacte', es: 'Punto exacto', en: 'Exact point' },
  'search.searching': { ca: 'Cercant…', es: 'Buscando…', en: 'Searching…' },
  'search.empty': { ca: 'Cap resultat amb aquest nom.', es: 'Ningún resultado con ese nombre.', en: 'No results found with that name.' },
  'search.offline': {
  ...
  'kind.peak': { ca: 'Cim o coll', es: 'Cima o puerto', en: 'Peak or pass' },
  'kind.settlement': { ca: 'Nucli', es: 'Núcleo', en: 'Settlement' },
  ...
  'intro.title': { ca: 'Tot depèn d’on siguis', es: 'Todo depende de dónde estés', en: 'Everything depends on where you are' },
  'intro.body': {
  ...
  'intro.accept': { ca: 'Fes servir el GPS', es: 'Usa el GPS', en: 'Use GPS' },
  'intro.pick': { ca: 'Trio el lloc jo', es: 'Elijo el lugar yo', en: 'I’ll choose the location' },
  'intro.skip': { ca: 'Mira-ho amb un punt d’exemple', es: 'Míralo con un punto de ejemplo', en: 'View with an example point' },

  /* --- comparació -------------------------------------------------------- */
  'compare.title': { ca: 'Compara dos llocs', es: 'Compara dos lugares', en: 'Compare two locations' },
  'compare.pick': {
  ...
  'compare.clear': { ca: 'Deixa de comparar', es: 'Deja de comparar', en: 'Stop comparing' },
  'compare.swap': { ca: 'Vés-hi', es: 'Ve allí', en: 'Go there' },
  'compare.here': { ca: 'On ets ara', es: 'Donde estás ahora', en: 'Where you are now' },
  'compare.other': { ca: 'L’altre lloc', es: 'El otro lugar', en: 'The other location' },
  'compare.delta': { ca: 'Diferència', es: 'Diferencia', en: 'Difference' },
  'compare.distance': { ca: 'Distància', es: 'Distancia', en: 'Distance' },
  'compare.gain': {
  ...
  'compare.later': { ca: 'més tard', es: 'más tarde', en: 'later' },
  'compare.earlier': { ca: 'abans', es: 'antes', en: 'earlier' },
  'compare.noCentral': { ca: 'Sense fase central', es: 'Sin fase central', en: 'No central phase' },

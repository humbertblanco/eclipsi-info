...
const FR_STRINGS = {
  'card.score': 'Pourquoi ce lieu est intéressant',
  'card.scoreIntro': 'Note transparente du moteur de recherche : chaque ligne indique les points qu’elle apporte.',
  'card.scoreSeconds': 'Phase centrale visible',
  'card.scoreClearance': 'Marge au-dessus du relief',
  'card.scoreDistance': 'Proximité',
  'card.scoreAltitude': 'Altitude gagnée',
  'card.scoreWeather': 'La météo n’entre pas dans cette note : consultez Nuages, car les conditions évoluent.',
  'panel.title': 'Chercher où gagner des secondes',
  'panel.lead': 'Comparez les points proches selon la durée visible, le relief et la distance.',
  'panel.search': 'Trouver de meilleurs lieux à proximité',
  'panel.searchAgain': 'Relancer la recherche',
  'panel.stop': 'Arrêter',
  'panel.needOrigin': 'Votre position est nécessaire pour effectuer une recherche à proximité.',
  'panel.cancelled': 'Recherche arrêtée. Aucune donnée supplémentaire n’a été téléchargée.',
  'panel.failed': 'Le calcul des lieux a échoué.',
  'panel.progressLabel': 'Progression de la recherche',
  'panel.dataWarning': 'Télécharge le relief de toute la zone alentour, soit plusieurs dizaines de mégaoctets. Si votre forfait mobile est limité, faites-le avant de partir.',
  'panel.origin': 'Votre position actuelle',
  'panel.originVisible': 'Vous verriez {visible} sur les {total} de la phase centrale.',
  'panel.originPending': 'La phase centrale théorique dure {total}. Il reste à calculer la partie masquée par le relief.',
  'panel.originNoCentral': 'Il n’y a pas de phase centrale à cet endroit.',
  'stage.grid': 'Préparation de la grille de candidats',
  'stage.astro': 'Calcul de l’éclipse à chaque point',
  'stage.tiles': 'Téléchargement du relief de la zone',
  'stage.sieve': 'Filtrage selon l’horizon',
  'stage.refineTiles': 'Téléchargement du relief des finalistes',
  'stage.refine': 'Calcul du profil d’horizon complet des finalistes',
  'stage.done': 'Terminé',
  'list.empty': 'Dans un rayon de {radius}, aucun point ne permet au Soleil de rester au-dessus de l’horizon pendant l’éclipse. Essayez d’augmenter le rayon.',
  'list.contextOne': '{n} lieu parmi {candidates} points examinés dans un rayon de {radius}.',
  'list.contextMany': '{n} lieux parmi {candidates} points examinés dans un rayon de {radius}.',
  'list.best': 'La meilleure phase centrale de la zone dure {duration}.',
  'list.noCentral': 'La bande de centralité n’atteint pas ce rayon : la liste est classée selon l’horizon et la distance, et non selon les secondes de totalité.',
  'list.estimate': 'Tous ces chiffres sont des estimations de filtrage fondées sur un relief à faible résolution. Ils peuvent différer de plusieurs dizaines de secondes.',
  'list.featured': 'Les 3 meilleures options',
  'list.more': 'Afficher {n} options supplémentaires',
  'list.less': 'Masquer les autres',
  'list.caveat': 'Le relief provient d’un modèle de terrain nu : il ne comprend ni arbres, ni bâtiments, ni clôtures. Une rangée de peupliers à 500 m peut masquer 2°. Avec moins d’un demi-degré de marge, rendez-vous sur place à l’avance pour vérifier la vue.',
  'card.rank': 'Position {n}',
  'card.verdict.none': 'Aucune phase centrale',
  'card.verdict.blocked': 'Masquée',
  'card.verdict.full': 'Entière',
  'card.verdict.partial': 'Partielle',
  'card.willSee': 'Vous verrez',
  'card.thereIs': 'Disponible',
  'card.clearance': 'Marge au-dessus du relief',
  'card.gain': 'Vous gagnez {duration} par rapport à votre position actuelle.',
  'card.blocking': 'Le relief atteint {altitude}{distance}. Le Soleil passe {clearance} au-dessus.',
  'card.blockingEats': 'Le relief atteint {altitude}{distance} et masque le Soleil de {clearance}.',
  'card.at': ' à {distance}',
  'card.lostNoClimb': 'Vous perdez {lost} et monter davantage depuis ce point ne permettra pas de les récupérer.',
  'card.lostClimb': 'Vous perdez {lost}. Une montée de {climb} permettrait de les récupérer.',
  'card.coords': 'Coordonnées',
  'card.midCentral': 'Milieu de la phase centrale',
  'card.sun': 'Soleil',
  'card.sieve': 'Estimation avec relief à faible résolution',
  'card.edge': 'Bord de la bande',
  'card.coverage': 'Relief incomplet ({percent})',
  'card.copy': 'Copier les coordonnées',
  'card.copied': 'Copiées',
  'card.share': 'Partager',
  'card.linkCopied': 'Lien copié',
  'card.openMap': 'Ouvrir dans la carte',
  'card.makeMine': 'Calculer depuis ce point',
  'cost.title': 'Coût de l’entonnoir',
  'cost.tiles': 'tuiles',
  'cost.stage': 'Étape',
  'cost.in': 'Entrée',
  'cost.out': 'Sortie',
  'cost.time': 'Temps',
  'cost.ephemeris': 'Éphémérides',
  'cost.samples': 'Échantillons',
  'cost.tilesCol': 'Tuiles',
  'cost.candidates': 'Candidats',
  'cost.totalTime': 'Temps total',
  'cost.downloaded': 'Tuiles téléchargées',
  'cost.naive': 'Avec un calcul candidat par candidat',
  'cost.netSaving': 'Économie de données réseau',
  'cost.terrainSaving': 'Économie de données de relief',
  'cost.note': 'Les chiffres de droite indiquent le coût d’un calcul individuel du profil complet de chaque candidat. Si l’économie devient inférieure à un facteur d’environ cent, il convient de revoir les paramètres de filtrage.',
  'cost.stage.grid': 'Grille de candidats',
  'cost.stage.astro': 'A · Astronomie peu coûteuse',
  'cost.stage.tiles': 'B · Tuiles partagées',
  'cost.stage.sieve': 'C · Filtrage selon l’horizon',
  'cost.stage.refineTiles': 'D1 · Tuiles des finalistes',
  'cost.stage.refine': 'D2 · Calcul complet',
  'error.cancelled': 'Recherche arrêtée.',
  'error.noTerrain': 'Aucune tuile de relief n’a été reçue et il est impossible de vérifier les horizons sans données de relief. Vérifiez votre connexion.',
  'error.terrainIncomplete': 'Une partie du relief n’a pas pu être téléchargée. Avec des données incomplètes, les lieux proposés seraient faussement optimistes ; il est donc plus sûr de ne pas les afficher. Vérifiez votre connexion.',
  'error.unknown': 'Les lieux n’ont pas pu être calculés. Réessayez.',
  'error.worker': 'La recherche s’est interrompue de façon inattendue. Réessayez ; si le problème persiste, fermez puis rouvrez l’application.',
  'error.noWorker': 'Ce navigateur ne peut pas calculer les lieux en arrière-plan.',
} as const satisfies Record<keyof typeof STRINGS, string>;
...
export function sp(
  ...
  const text = locale === 'fr' ? FR_STRINGS[key] : STRINGS[key][locale];
  if (!vars) return text;
